    ...
    },
    {
        ...
        body: (
            <>
                ...
                theory suggests that early in a product's life-cycle all the parts and labor associated with that product come from
...
by its original country of invention.<sup>i</sup></p>
                ...
                complex factors of the current agitation, but
                let’s assume that part of the frustration comes
                from living in the urban cities which offer little
                and dwindling COMMERCIAL opportunities
                against the vacation of manufacturing and
                related jobs to other parts of the globe as
                indicated by this model. The model helps to
                explain the evacuation of manufacturing that
                took place in the United States in the last 50
                years or so. Who is to blame? Is it China? Is it
                the Republicans, who in modern times are the
                party of big business? Is it President Trump,
                who has campaigned on bringing those types of jobs back to America? Is it the Democrats, who claim to be the
                party of the people while in the 1990s subjected Americans to the very “free trade” agreements under Bill Clinton
                that helped create the condition? Is it the Confederates again, whose symbols are now under attack? Is it the
                corporations that choose to offshore for cheap labor? Is it the Federal Government that allows these corporations
                to offshore? Is it the state governments from where these corporations get their charters? We can point fingers
                until doomsday. But in light of the public relations blitz during the COVID-19 pandemic and protests by Black
                Lives Matter, Antifa, and other groups, many of these corporations have stated that, “we’re here to help.” If they
                are sincere then the Nikes, the Walmarts, and the Amazons of the world that espouse superficial political
                correctness should be transforming our rusty and toxic cities into productive centers again. This would be an
                exercise of true political correctness to the sovereign. The questions are, do they have a sovereign, and do the
                governors of these states and the mayors of these cities want the same? Are they willing to cede some tax
                revenue, both corporate and personal in order to facilitate this process? Not to apologize for what should be
...
sometimes referred to as the Second American System.</p>
                ...
                <p>
                    ...
                    and apply it to education, which has been the
                    bellows to more money as the solution to
                    economic inequality. After World War II and
                    the space race, much of the education
                    systems and curriculum were designed
                    around jobs surrounding the military
                    industrial complex. It became the goal of
                    most schools to prepare their students for
                    college. But the ideal of higher education
                    was not new. It too was proliferated with the
                    Second American System. A system that was
                    an expansion of federal power which usurped general Democratic Party opposition, ex parte with secession. As
                    Dr. Eric Rauchway of the University of California, Davis, puts it, it was a highly ambitious set of laws, providing
                    federal aid for the transcontinental railroad, for the state university system, for the settlement of the West by
                    ...
                    Joseph Wharton (1881), Stanford University-Leland Stanford (1885), Drexel University-Anthony Drexel (1891),

                    et al. From an industrial age perspective, since the last half of the 20<sup>th</sup>-century, the schools have been flooded by
                    the late majority and laggards. This is not a critique of the talent or intelligence of the population, but the
                    population’s position related to the productive capacities that the university system once supported. The shift
                    is now centered around administration and the healthcare industrial complex, of which there seems to be a crisis.
                    The next question becomes, “is the university and credentialing system saturated and are universities applying
                    the same marketing approach to sustain their product’s lifecycle?” Workers in the field will give you a different
                    answer than recent college graduates and their helicopter parents.
                </p>
                <p>
                    In regard to healthcare, in which there is a direct conflict between both capitalism, socialism, and care, we can
