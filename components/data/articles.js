export default [
    ...
    },
    {
        ...
        body: (<>
            <h4 className={`textColorPrimary schadow`}>HOW THE WORLD WAS FASHIONED <br /> BY PIN PRICKS</h4>
            <p>
                <em>
    ...
    },
    {
        ...
        body: (<>
            ...
            <p>
                ...
                transportation resulting from cartelization. In the late 19<sup>th</sup>-century railroads became so prolific, partly due to the
